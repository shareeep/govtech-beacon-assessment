...
description: AI-driven digital transformation proposal featuring a YOLOv11s visual checkout model (Macro F1 0.88), AutoRec recommender system, and mobile-first Figma prototypes.
...
projectType: "AI/ML"
highlights:
  - YOLOv11s object detection model (Macro F1 0.88) trained on 324 hand-labelled images for visual checkout
  - AutoRec neural collaborative filtering recommender for personalised product suggestions
  - Mobile-first Figma prototypes for 3 integrated features (ordering, AI checkout, recommendations)
---
