...
description: Migrated a subscription-based meal ordering system from Odoo SaaS to Azure AKS, cutting per-user costs by 40%+ and scaling to 10,000+ daily users with DevSecOps practices.
...
projectType: "SWE"
highlights:
  - Migrated SaaS to Azure AKS with 40%+ infrastructure cost reduction
  - HPA autoscaling for 10K+ daily users with 0% error rate under load testing
  - DevSecOps pipeline with K8s YAML IaC, HTTPS (Cert Manager), RBAC, and Prometheus + Grafana monitoring
---
