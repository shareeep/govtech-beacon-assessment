...
description: A character-level CNN phishing URL detector achieving 94.8% accuracy with explainable attention heatmaps, validated against real-world Singapore government impersonation attacks.
...
projectType: "AI/ML"
highlights:
  - Character-level CNN achieving 94.8% accuracy on 235K-sample phishing URL dataset
  - Multi-category feature engineering (lexical, host-based, content-based) for robust detection
  - Explainable attention heatmaps visualising per-character phishing risk contributions
---
