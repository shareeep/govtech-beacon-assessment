...
description: A full-stack food delivery platform with 6+ containerised microservices, Saga orchestration via Kafka and Temporal, Stripe Connect payments, and event-driven architecture.
...
projectType: "SWE"
highlights:
  - 6+ containerised microservices with dedicated PostgreSQL databases and Docker
  - Saga orchestration with Kafka (pub-sub) and Temporal (deterministic workflows) including compensation rollbacks
  - Stripe Connect split payments, Clerk OAuth, and Grafana observability
---
