...
description: Systematic comparison of full fine-tuning vs. LoRA across 4 transformer models (RoBERTa, BERT, HateBERT, ELECTRA), achieving Macro F1 0.689 on HateXplain and outperforming community baselines.
...
projectType: "AI/ML"
highlights:
  - Fine-tuned RoBERTa to Macro F1 0.689, outperforming HateBERT and community baselines
  - Systematic comparison: full fine-tuning yields +9% F1 over LoRA (0.71% params) on smaller encoders
  - Benchmarked 4 transformer architectures under identical conditions with weighted cross-entropy for class imbalance
---
