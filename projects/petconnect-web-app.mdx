...
description: A full-stack social platform (Vue 3, Express.js, Firebase) with real-time chat, Google Maps event discovery, and social networking features, deployed on Render.
...
projectType: "SWE"
highlights:
  - Vue 3 SPA with Express.js backend and Firebase (Firestore, Auth, Cloud Storage)
  - Real-time chat, event discovery with Google Maps API, and social feed features
  - Deployed frontend and backend on Render with modular Express routers
---
