...
description: Scrum Master and Developer delivering a microservices application over 3 sprints with a two-layer CI pipeline (pre-push hooks + GitHub Actions), 8 Playwright E2E suites, and 70% coverage enforcement.
...
projectType: "SWE"
highlights:
  - Led Scrum ceremonies (planning, standups, retros) across 3 two-week sprints with velocity calibration
  - Two-layer CI: local pre-push hooks + GitHub Actions with parallel testing across 11 services (70% coverage)
  - 8 Playwright E2E test suites and unit tests for 14/17 microservices, evolving from manual to full automation
---
